...
func TestReElection2A(t *testing.T) {
	...
	fmt.Println("Pass ReElection2A Phase0")
	// if the leader disconnects, a new one should be elected.
	cfg.disconnect(leader1)
	cfg.checkOneLeader()
	fmt.Println("Pass Relection2A Phase1")
	// if the old leader rejoins, that shouldn't
	// disturb the old leader.
	cfg.connect(leader1)
	leader2 := cfg.checkOneLeader()
	fmt.Println("Pass Relection2A Phase2")
	...
	fmt.Println("Pass Relection2A Phase3")
	// if a quorum arises, it should elect a leader.
	cfg.connect((leader2 + 1) % servers)
	cfg.checkOneLeader()
	fmt.Println("Pass Relection2A Phase4")
	// re-join of last node shouldn't prevent leader from existing.
	cfg.connect(leader2)
	cfg.checkOneLeader()
	fmt.Println("Pass Relection2A Phase5")
	fmt.Printf("  ... Passed\n")
}
...
func TestFailAgree2B(t *testing.T) {
	...
	fmt.Println("FailedAgree2B Mid Phase")
...
func TestBackup2B(t *testing.T) {
	...
	fmt.Printf("TestBackup2B:Phase1, start\n")
	// submit lots of commands that won't commit
	for i := 0; i < 50; i++ {
		cfg.rafts[leader1].Start(rand.Int())
	}
	fmt.Printf("TestBackup2B:Phase1, End\n")
	...
	fmt.Printf("TestBackup2B:Phase2, End")
	time.Sleep(RaftElectionTimeout / 2)
	...
	cfg.connect(other)
	fmt.Printf("TestBackup2B:Phase3, start\n")
	...
	fmt.Printf("TestBackup2B:Phase4, Leader;%d\n", leader4)
...
func TestPersist22C(t *testing.T) {
	...
	for iters := 0; iters < 5; iters++ {
		...
		cfg.one(10+index, servers-2)
		index++
		fmt.Printf("Phase3:Iter:%d,leader1:%d\n", iters, leader1)
		cfg.connect((leader1 + 4) % servers)
		cfg.connect((leader1 + 0) % servers)
	}
	fmt.Printf("Phase3\n")
